 ...
 * @author userpc
 */
public class UpdateProblemAdminController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        prob = AdminListeProblemeController.prob2;
     ...
     public void onBtnModifierClicked(ActionEvent event){
      ...
      public void onBtnSupprimerClicked(ActionEvent event){
        ...
        try {
            ...
            Logger.getLogger(UpdateProblemAdminController.class.getName()).log(Level.SEVERE, null, ex);
        }
