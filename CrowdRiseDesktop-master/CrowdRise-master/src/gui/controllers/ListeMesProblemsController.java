 ...
 * @author userpc
 */
public class ListeMesProblemsController implements Initializable {
   ...
   public void onAjoutClicked(ActionEvent event) throws IOException{
        Parent root=FXMLLoader.load(getClass().getResource("/gui/views/ProblemAdd.fxml"));
        Stage stage = new Stage();
            stage.initModality(Modality.WINDOW_MODAL);
            stage.initStyle(StageStyle.DECORATED);
            stage.setTitle("Ajout Probleme!");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        liste2 = problemdao.displayByIdMembre(1);
    ...
    public void changed(ObservableValue<? extends Problem> observable, Problem oldValue, Problem newValue) {
        ...
        Parent root;
        try {
            root = FXMLLoader.load(getClass().getResource("/gui/views/updateProblem.fxml"));
            Stage stage = new Stage();
            stage.initModality(Modality.WINDOW_MODAL);
            stage.initStyle(StageStyle.DECORATED);
            stage.setTitle("Informations Problem");
            stage.setScene(new Scene(root));  
            stage.show();
        } catch (IOException ex) {
            Logger.getLogger(ListeMesProblemsController.class.getName()).log(Level.SEVERE, null, ex);
        }
       }
     });
        init();
