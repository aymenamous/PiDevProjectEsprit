 ...
 * @author userpc
 */
public class ListIdeesCanvas extends Canvas implements CommandListener,Runnable{
    ...
    public ListIdeesCanvas(Display d) {
       this.disp=d;
    ...
    protected void paint(Graphics g) {
        ...
        try {
            ...
            Image img2 =Image.createImage("/Gui/star.png");
            Image img3 =Image.createImage("/Gui/emptystar.png");
            ...
            if (y>=5) {
              for (int i = x; i < x+5; i++) {
                ...
                int vote = nbVote(idee[i].getId());
                if (vote==0) {
                        g.drawImage(img3, w-60, h1, 0);
                        g.drawImage(img3, w-40, h1, 0);
                        g.drawImage(img3, w-20, h1, 0); 
                    }else if (vote==1){
                        g.drawImage(img2, w-60, h1, 0);
                        g.drawImage(img3, w-40, h1, 0);
                        g.drawImage(img3, w-20, h1, 0);
                    }else if (vote==2){
                        g.drawImage(img2, w-60, h1, 0);
                        g.drawImage(img2, w-40, h1, 0);
                        g.drawImage(img3, w-20, h1, 0);
                    }else if (vote>2){
                        g.drawImage(img2, w-60, h1, 0);
                        g.drawImage(img2, w-40, h1, 0);
                        g.drawImage(img2, w-20, h1, 0);
                    }
                h1=h1+40;
            }  
            }else{
        ...
        switch (getGameAction(keyCode)) {
            ...
            case (DOWN):
               if (pos==1 && pos<y) {
                ...
                break;
            case (FIRE):
                Midlet.currentPosition="listIdées";
    ...
    public void run() {
        try {
            ...
            HttpConnection hc = (HttpConnection) Connector.open("http://localhost/crowdrise/idees/select_idee.php");
    ...
    public int nbVote(int id){
        try {
            HttpConnection con = (HttpConnection) Connector.open("http://localhost/crowdrise/vote/count_vote_projet.php?id=" + id);
