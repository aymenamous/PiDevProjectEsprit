...
public class Spinner extends Canvas 
{
    ...
    public Spinner() throws IOException {
    ...
    protected void paint(Graphics g) {
        ...
        g.drawString("Authentification En Cours",  (w / 2), h / 4, Graphics.HCENTER | Graphics.BASELINE);
        ...
        public void run() {
            ...
            if(count  == 30)
            {
                ...
                Midlet.menuPrincipal.show();
                    //Midlet.md.disp.setCurrent(new MembreLogin("ff"));
                    System.out.println("HERE OKKK");
