 ...
 * @author userpc
 */
public class ListIdeeAdminCanvas extends Canvas implements CommandListener,Runnable{
    ...
    public ListIdeeAdminCanvas(Display d) {
       this.disp=d;
        ...
        switch (getGameAction(keyCode)) {
            ...
            case (DOWN):
               if (pos==1 && pos<y) {
                ...
                break;
            case (FIRE):
                Midlet.currentPosition="listIdéesAdmin";
